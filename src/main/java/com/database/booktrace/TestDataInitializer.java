...
import com.database.booktrace.Domain.Book;  // 이거로 바꿔야 함!
...
import java.util.ArrayList;  // 이것도 추가!
...
public class TestDataInitializer {
    ...
    public void initTestData() {
        ...
        testUser.setPreferredCategories(Set.of(BookCategory.COMPUTER, BookCategory.NOVEL));
        ...
        book5.setCategory(BookCategory.BUSINESS);
        ...
        book8.setCategory(BookCategory.PHILOSOPHY);
        ...
        book9.setCategory(BookCategory.ART);
