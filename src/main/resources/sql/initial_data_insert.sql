INSERT INTO USERS VALUES (1, '김눈송', 'kimsnow', 'pass1234', 0, '[''TECHNOLOGY'', ''NOVEL'']', 'Y',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO USERS VALUES (2, '이바람', 'windlee', 'wind1234', 0, '[''LITERATURE'']', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO USERS VALUES (3, '최별빛', 'starchoi', 'star5678', 0, '[''HISTORY'', ''SCIENCE'']', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO USERS VALUES (4, '박햇살', 'sunpark', 'sun9999', 0, '[''SELF_DEVELOPMENT'']', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO USERS VALUES (5, '장초롱', 'janglamp', 'light321', 0, '[''ECONOMY'']', 'N', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO READING_LOG VALUES (1, 5, 1, TO_TIMESTAMP('2025-06-08 03:19:26', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2025-06-14 03:19:26', 'YYYY-MM-DD HH24:MI:SS'), 5, 100, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO READING_LOG VALUES (2, 5, 2, TO_TIMESTAMP('2025-06-01 03:19:26', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2025-06-10 03:19:26', 'YYYY-MM-DD HH24:MI:SS'), 10, 80, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
